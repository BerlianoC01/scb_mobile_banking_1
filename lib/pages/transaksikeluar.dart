...
import 'package:scb_mobile_banking/database/readdata.dart';
...
class transaksiKeluar extends StatefulWidget {
  ...
  @override
  _transaksiKeluarState createState() => _transaksiKeluarState();
}
...
class _transaksiKeluarState extends State<transaksiKeluar> {
  ...
  Future getDocID() async {
    await FirebaseFirestore.instance.collection('Transaksi').get().then(
        ...
        body: Stack(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Container(
                  padding: EdgeInsets.fromLTRB(4, 7, 0, 420),
                  width: double.infinity,
                  decoration: BoxDecoration(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              'Untar BPP-Rendy Khosesa          -7.500.000',
                              style: TextStyle(
                                // 'Inter',
                                fontSize: 20,
                                fontWeight: FontWeight.w400,
